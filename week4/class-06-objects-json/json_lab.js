...
var grungeAlbumsJSON = JSON.stringify({
  "albums":[
    {
        "name": "Bleach",
        "artist": "Nirvana",
...
for (var i = 0; i < grungeAlbumsParsed.albums.length; i++){
    console.log("Album: ", grungeAlbumsParsed.albums[i].name);
    console.log("Artist Name: ", grungeAlbumsParsed.albums[i].artist);
    console.log("Units Sold: ", grungeAlbumsParsed.albums[i].unitsSold);
}
